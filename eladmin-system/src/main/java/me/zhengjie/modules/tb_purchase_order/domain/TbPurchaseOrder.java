package me.zhengjie.modules.tb_purchase_order.domain;
...
public class TbPurchaseOrder extends CommonModel<TbPurchaseOrder> implements Serializable {
    ...
    public void copyFrom(TbPurchaseOrder source){
