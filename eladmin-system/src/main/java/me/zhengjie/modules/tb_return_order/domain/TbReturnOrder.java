package me.zhengjie.modules.tb_return_order.domain;
...
public class TbReturnOrder extends CommonModel<TbReturnOrder> implements Serializable {
    ...
    public void copyFrom(TbReturnOrder source){
