...
public class SellOrdersServiceImpl extends CommonServiceImpl<TbOrdersMapper, TbOrders> implements SellOrdersService {
    ...
    public int insert(OrderVo vo) {
        ...
        // 单号
        entity.setOrderNo(orderUtil.getIncrOrderNo(CommonConstant.XS));
        // 单据类型为销退
    ...
    public Object getOrderNo() {
        return orderUtil.getOrderNoForShow(CommonConstant.XS);
    }
