...
public class InventoryOrdersServiceImpl extends CommonServiceImpl<TbOrdersMapper, TbOrders> implements InventoryOrdersService {
    ...
    public PageInfo<TbOrdersDto> queryAll(TbOrdersQueryParam query, Pageable pageable) {
        ...
        predicate.eq("order_type", OrderTypeEnum.INVENTORY.getCode());
    ...
    public int insert(OrderVo vo) {
        ...
        // 单号
        entity.setOrderNo(orderUtil.getIncrOrderNo(CommonConstant.PD));
        // 单据类型为盘点
        entity.setOrderType(OrderTypeEnum.INVENTORY.getCode());
        // 单据状态
        ...
        for (GoodsInfoVo goodsInfoVo : goodList) {
            ...
            tbOrderGoods.setPaperGoodNum(goodsInfoVo.getPaperGoodNum());
            tbOrderGoods.setInventoryGoodNum(goodsInfoVo.getInventoryGoodNum());
            tbOrderGoods.setPlGoodNum(goodsInfoVo.getPlGoodNum());
            tbOrderGoods.setPlPrice(goodsInfoVo.getPlPrice());
    ...
    public Object getOrderNo() {
        return orderUtil.getOrderNoForShow(CommonConstant.PD);
    }
                ...
                try {
                    ...
                    for (TbOrderGoods tbOrderGoods : oldOrderGoodList) {
                        TbWhInventory one = tbWhInventoryMapper.lambdaQuery()
                                ...
                                .one();
                        one.setCount(tbOrderGoods.getInventoryGoodNum());
                ...
                try {
                    ...
                    for (TbOrderGoods tbOrderGoods : oldOrderGoodList) {
                        TbWhInventory one = tbWhInventoryMapper.lambdaQuery()
                                ...
                                .eq(TbWhInventory::getGoodId, tbOrderGoods.getGoodId())
                                .one();
                        one.setCount(tbOrderGoods.getPaperGoodNum());
                        tbWhInventoryMapper.updateById(one);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
