...
public class SellRefundOrdersServiceImpl extends CommonServiceImpl<TbOrdersMapper, TbOrders> implements SellRefundOrdersService {
    ...
    public PageInfo<TbOrdersDto> queryAll(TbOrdersQueryParam query, Pageable pageable) {
        ...
        predicate.eq("order_type", OrderTypeEnum.SELL_REFUND.getCode());
    ...
    public int insert(OrderVo vo) {
        ...
        // 单号
        entity.setOrderNo(orderUtil.getIncrOrderNo(CommonConstant.XT));
        // 单据类型为销退
    ...
    @Override
    public Object getCustomerSelect() {
        List<TbPartnerCompanyInfo> list = tbPartnerCompanyInfoMapper.lambdaQuery()
                .in(TbPartnerCompanyInfo::getType, EnterpriseTypeEnum.CUSTOMER.getCode(), EnterpriseTypeEnum.BOTH.getCode()).list();
    ...
    public Object getOrderNo() {
        return orderUtil.getOrderNoForShow(CommonConstant.XT);
    }
    ...
    public void printOrderReport(String id, HttpServletResponse response) throws Exception {
        ...
        TbOrders order = tbOrdersMapper.lambdaQuery()
                ...
                .eq(TbOrders::getOrderType, OrderTypeEnum.SELL_REFUND.getCode())
                .one();
