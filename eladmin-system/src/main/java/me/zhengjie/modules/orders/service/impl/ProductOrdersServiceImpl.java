...
public class ProductOrdersServiceImpl extends CommonServiceImpl<TbOrdersMapper, TbOrders> implements ProductOrdersService {
    ...
    public PageInfo<TbOrdersDto> queryAll(TbOrdersQueryParam query, Pageable pageable) {
        ...
        predicate.eq("order_type", OrderTypeEnum.PRODUCE.getCode());
    ...
    public int insert(OrderVo vo) {
        ...
        // 单号
        entity.setOrderNo(orderUtil.getIncrOrderNo(CommonConstant.SC));
        // 单据类型为生产
    ...
    public void download(List<TbOrdersDto> all, HttpServletResponse response) throws IOException {
      ...
      for (TbOrdersDto tbOrders : all) {
        Map<String,Object> map = new LinkedHashMap<>();
              ...
              map.put("生产单状态 1 未审批 2 已通过 3 反审核", tbOrders.getStatus());
    ...
    public Object getOrderNo() {
        return orderUtil.getOrderNoForShow(CommonConstant.SC);
    }
    ...
    public void printOrderReport(String id, HttpServletResponse response) throws Exception {
        ...
        TbOrders order = tbOrdersMapper.lambdaQuery()
                ...
                .eq(TbOrders::getOrderType, OrderTypeEnum.PRODUCE.getCode())
                .one();
