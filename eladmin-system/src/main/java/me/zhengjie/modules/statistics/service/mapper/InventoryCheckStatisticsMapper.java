...
*/
@Repository
public interface InventoryCheckStatisticsMapper extends CommonMapper<TbWhInventory> {

    IPage<InventoryCheckStatisticsDto> queryAll(IPage<InventoryCheckStatisticsDto> queryPage, @Param("query") ProductStatisticsQueryParam query);
