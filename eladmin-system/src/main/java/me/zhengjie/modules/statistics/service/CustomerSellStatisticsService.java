...
* @date 2021-12-01
*/
public interface CustomerSellStatisticsService extends CommonService<TbWhInventory>  {
     ...
     */
    PageInfo<CustomerSellStatisticsDto> queryAll(PurchaseStatisticsQueryParam query, Pageable pageable);
