...
* @date 2021-12-01
*/
public interface ProductStatisticsService extends CommonService<TbWhInventory>  {
     ...
     */
    PageInfo<ProductStatisticsDto> queryAll(ProductStatisticsQueryParam query, Pageable pageable);
