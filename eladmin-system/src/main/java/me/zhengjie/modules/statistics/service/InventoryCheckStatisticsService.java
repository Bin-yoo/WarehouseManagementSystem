...
* @date 2021-12-01
*/
public interface InventoryCheckStatisticsService extends CommonService<TbWhInventory>  {
     ...
     */
    PageInfo<InventoryCheckStatisticsDto> queryAll(ProductStatisticsQueryParam query, Pageable pageable);
