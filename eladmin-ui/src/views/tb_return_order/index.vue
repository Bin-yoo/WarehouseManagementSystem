    ...
    <div class="head-container">
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          <el-form-item label="退货单id" prop="id">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="id" label="退货单id" />
        ...
        <el-table-column v-if="checkPer(['admin','tbReturnOrder:edit','tbReturnOrder:del'])" label="操作" width="150px" align="center">
...
<script>
import crudTbReturnOrder from '@/api/tbReturnOrder'
...
const defaultForm = { id: null, orderNo: null, orderDate: null, orderPersonId: null, orderPerson: null, inDate: null, inWhId: null, inWhName: null, customerId: null, customer: null, originOrderNo: null, remark: null, status: null }
export default {
  name: 'TbReturnOrder',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: 'tb_return_order', url: 'api/tbReturnOrder', idField: 'id', sort: 'id,desc', crudMethod: { ...crudTbReturnOrder }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'tbReturnOrder:add'],
        edit: ['admin', 'tbReturnOrder:edit'],
        del: ['admin', 'tbReturnOrder:del']
      },
      rules: {
        id: [
