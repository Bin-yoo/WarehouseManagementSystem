  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="checkPer(['admin','tbPurchaseOrder:edit','tbPurchaseOrder:del'])" label="操作" width="150px" align="center">
...
<script>
import crudTbPurchaseOrder from '@/api/tbPurchaseOrder'
...
const defaultForm = { id: null, orderNo: null, orderDate: null, orderPersonId: null, orderPerson: null, inDate: null, inWhId: null, inWhName: null, supplierId: null, supplier: null, originOrderNo: null, remark: null, status: null }
export default {
  name: 'TbPurchaseOrder',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: 'tb_purchase_order', url: 'api/tbPurchaseOrder', idField: 'id', sort: 'id,desc', crudMethod: { ...crudTbPurchaseOrder }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'tbPurchaseOrder:add'],
        edit: ['admin', 'tbPurchaseOrder:edit'],
        del: ['admin', 'tbPurchaseOrder:del']
      },
      rules: {
        id: [
