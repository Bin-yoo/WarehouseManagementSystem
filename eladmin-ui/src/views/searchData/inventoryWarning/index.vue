...
import InventoryWarning from '@/api/inventoryWarning'
...
export default {
  ...
  cruds() {
    return CRUD({ title: '查看库存详情', url: 'api/inventoryWarning', idField: 'whId', sort: 'whId,desc', crudMethod: { ...InventoryWarning }})
  },
  dicts: ['order_type'],
  data() {
    return {
      permission: {
        add: ['admin', 'inventoryWarning:add'],
        edit: ['admin', 'inventoryWarning:edit'],
        del: ['admin', 'inventoryWarning:del']
      },
      whSelect: [],
      types: [],
      unitSelect: [],
