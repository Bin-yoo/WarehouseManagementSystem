<template>
  <el-row :gutter="40" class="panel-group">
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="purchaseOrderCount()">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="panelData.purchaseOrderCount" :duration="2600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="sellOrderCount()">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="panelData.sellOrderCount" :duration="3000" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="waitApproveOrderCount()">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="panelData.waitApproveOrderCount" :duration="3200" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="inventoryWarningCount()">
