...
<script>
import PurchaseStatistics from '@/api/purchaseStatistics.js'
...
export default {
  ...
  cruds() {
    return CRUD({ title: '查看单据详情', url: 'api/purchaseStatistics', idField: 'id', sort: 'id,desc', crudMethod: { ...PurchaseStatistics }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'purchaseStatistics:add'],
        edit: ['admin', 'purchaseStatistics:edit'],
        del: ['admin', 'purchaseStatistics:del']
      },
      dialogShow: false,
      detailData: [],
  ...
  methods: {
    ...
    showDetail(goodId) {
      ...
      PurchaseStatistics.getDetail(params).then(res => {
