  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="checkPer(['admin','deptProductStatistics:list'])" fixed="right" label="操作" width="295px" align="center">
          <template slot-scope="scope">
...
<script>
import DeptProductStatistics from '@/api/deptProductStatistics.js'
...
export default {
  name: 'DeptProductStatistics',
  components: { pagination, crudOperation, rrOperation, udOperation, GoodChooseBoard },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: '查看单据详情', url: 'api/deptProductStatistics', idField: 'id', sort: 'd.dept_id,desc', crudMethod: { ...DeptProductStatistics }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'deptProductStatistics:add'],
        edit: ['admin', 'deptProductStatistics:edit'],
        del: ['admin', 'deptProductStatistics:del']
      },
      dialogShow: false,
      detailData: [],
  ...
  methods: {
    ...
    showDetail(sourceId) {
      ...
      DeptProductStatistics.getDetail(params).then(res => {
