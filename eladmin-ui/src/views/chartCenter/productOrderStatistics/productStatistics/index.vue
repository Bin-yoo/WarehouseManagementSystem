...
<script>
import ProductStatistics from '@/api/productStatistics.js'
...
export default {
  ...
  cruds() {
    return CRUD({ title: '查看单据详情', url: 'api/productStatistics', idField: 'id', sort: 'goodId,desc', crudMethod: { ...ProductStatistics }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'productStatistics:add'],
        edit: ['admin', 'productStatistics:edit'],
        del: ['admin', 'productStatistics:del']
      },
      dialogShow: false,
      detailData: [],
  ...
  methods: {
    ...
    showDetail(goodId) {
      ...
      ProductStatistics.getDetail(params).then(res => {
