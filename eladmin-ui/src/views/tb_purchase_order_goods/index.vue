  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="checkPer(['admin','tbPurchaseOrderGoods:edit','tbPurchaseOrderGoods:del'])" label="操作" width="150px" align="center">
...
<script>
import crudTbPurchaseOrderGoods from '@/api/tbPurchaseOrderGoods'
...
export default {
  name: 'TbPurchaseOrderGoods',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: 'tb_purchase_order_goods', url: 'api/tbPurchaseOrderGoods', idField: 'goodId', sort: 'goodId,desc', crudMethod: { ...crudTbPurchaseOrderGoods }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'tbPurchaseOrderGoods:add'],
        edit: ['admin', 'tbPurchaseOrderGoods:edit'],
        del: ['admin', 'tbPurchaseOrderGoods:del']
      },
      rules: {
        orderId: [
