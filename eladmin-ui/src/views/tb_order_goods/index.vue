  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="checkPer(['admin','tbOrderGoods:edit','tbOrderGoods:del'])" label="操作" width="150px" align="center">
...
<script>
import crudTbOrderGoods from '@/api/tbOrderGoods'
...
const defaultForm = { orderId: null, goodId: null, goodNum: null, price: null, totalPrice: null, batch: null, productDate: null, validDate: null, remark: null }
export default {
  name: 'TbOrderGoods',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: 'tb_order_goods', url: 'api/tbOrderGoods', idField: 'goodId', sort: 'goodId,desc', crudMethod: { ...crudTbOrderGoods }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'tbOrderGoods:add'],
        edit: ['admin', 'tbOrderGoods:edit'],
        del: ['admin', 'tbOrderGoods:del']
      },
      rules: {
        orderId: [
