  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="checkPer(['admin','tbReturnOrderGoods:edit','tbReturnOrderGoods:del'])" label="操作" width="150px" align="center">
...
<script>
import crudTbReturnOrderGoods from '@/api/tbReturnOrderGoods'
...
export default {
  name: 'TbReturnOrderGoods',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: 'tb_return_order_goods', url: 'api/tbReturnOrderGoods', idField: 'goodId', sort: 'goodId,desc', crudMethod: { ...crudTbReturnOrderGoods }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'tbReturnOrderGoods:add'],
        edit: ['admin', 'tbReturnOrderGoods:edit'],
        del: ['admin', 'tbReturnOrderGoods:del']
      },
      rules: {
        orderId: [
