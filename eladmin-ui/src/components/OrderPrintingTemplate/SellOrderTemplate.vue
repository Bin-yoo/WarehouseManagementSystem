  ...
  >
    ...
    <div id="printMe" style="padding: 0 30px; color: #000000; width: 100%" v-loading="loading">
      ...
      <el-row style="margin: 20px 0 0 0; font-size: 12px;">
        ...
        <el-col :span="9">
          <span>出库日期:&nbsp;&nbsp;{{ templateData.inDate }}</span>
        </el-col>
        <el-col :span="6">
      ...
      <el-row style="margin: 20px 0 0 0; font-size: 12px;">
        <el-col :span="9">
          <span>仓库:&nbsp;&nbsp;{{ templateData.whName }}</span>
        </el-col>
        <el-col :span="9">
          <span>客&nbsp;&nbsp;&nbsp;&nbsp;户:&nbsp;&nbsp;{{ templateData.supplier }}</span>
        </el-col>
        <el-col :span="6">
...
export default {
  ...
  methods: {
    ...
    getOrderPrintingInfo() {
      this.loading = true
      SellOrders.getOrderPrintingInfo(this.orderId).then(res => {
